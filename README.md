...
![Data Pipeline Diagram](ete_football_diagram.png)
...
Wait 3 minutes and then open your browser at http://localhost:2626 (User: admin, Pass: admin) and trigger the football_etl_pipeline DAG
